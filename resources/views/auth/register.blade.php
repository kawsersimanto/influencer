          ...
          <div class="inflanar-signin__logins">
            ...
            <div class="inflanar-signin__header mg-btm-10">
              <div class="inflanar-signin__heading">
                <h4 class="inflanar-signin__title">Sign Up</h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group inflanar-form-input mg-top-20">
                          ...
                          <input class="ecom-wc__form-input" type="text" name="email"
                      ...
                      <div class="col-12">
                          ...
                          <div class="inflanar-signin__check-inline">
                            <div class="inflanar-signin__checkbox">
                              <div class="inflanar-signin__checkbox--group">
                                <input required class="inflanar-signin__form-check" id="checkbox" name="checkbox"
                                  type="checkbox">
                                <label for="checkbox">{{ __('admin.I agree with the') }} <a
                        ...
                        <div class="inflanar-signin__bottom mg-top-20">
                          <p class="inflanar-signin__text">{{ __('admin.Alread have an account?') }} <a
                      ...
                      <div class="col-12">
                        <div class="form-group mg-top-20">
                          <div class="inflanar-signin__check-inline">
                            <div class="inflanar-signin__checkbox">
                              <div class="inflanar-signin__checkbox--group">
                                <input required class="inflanar-signin__form-check" id="checkbox1"
                                  name="checkbox" type="checkbox">
                                <label for="checkbox1">{{ __('admin.I agree with the') }} <a
                                    href="{{ route('terms-conditions') }}"
                                    class="forgot-pass">{{ __('admin.Terms and Conditions') }}</a></label>
                              </div>
                            </div>
                        ...
                        <div class="inflanar-signin__bottom mg-top-20">
                          <p class="inflanar-signin__text">{{ __('admin.Dont’t have an aceount ?') }} <a
                              href="{{ route('login') }}">{{ __('admin.Login') }}</a></p>
                        </div>
                      </div>
                    </div>
