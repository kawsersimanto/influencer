              ...
              <div class="col-lg-9 col-md-8 col-12 mg-top-30">
                <div class="influencers-pinfo">
                  <div class="influencers-pinfo__content">
                    ...
                    <p class="influencers-pinfo__reviews bg-main text-black"><i
                        class="fas fa-star"></i>{{ __('admin.Reviews') }}<span>{{ $total_review }}</span></p>
                  </div>
                        ...
                        <ul class="influencers-pinfo__ssocial list-none">
                          @if ($influencer->facebook)
                            <li><a href="{{ $influencer->facebook }}"><img
                                  src="{{ asset('frontend/img/in-social1.svg') }}"></a></li>
                          @endif

                          @if ($influencer->tiktok)
                            <li><a href="{{ $influencer->tiktok }}"><img
                                  src="{{ asset('frontend/img/in-social2.svg') }}"></a></li>
                          @endif

                          @if ($influencer->twitter)
                            <li><a href="{{ $influencer->twitter }}"><img
                                  src="{{ asset('frontend/img/in-social3.svg') }}"></a></li>
                          @endif

                          @if ($influencer->instagram)
                            <li><a href="{{ $influencer->instagram }}"><img
                                  src="{{ asset('frontend/img/in-social4.svg') }}"></a></li>
                          @endif
            ...
            <div class="influencers-sidebar__single mg-top-50">
              ...
              <ul class="influencers-sidebar__contact list-none">
                <li><a href="tel:{{ html_decode($influencer->phone) }}"><i
                      class="fas fa-phone-alt !text-main"></i>{{ html_decode($influencer->phone) }}</a></li>
                <li><a href="mailto:{{ html_decode($influencer->email) }}"><i
                      class="fas fa-envelope !text-main"></i>{{ html_decode($influencer->email) }}</a></li>
                <li><a href="https://www.google.com/maps" target="_blank"><i class="fa-solid fa-location-dot !text-main"></i>{{ html_decode($influencer->address) }}</a></li>
              </ul>
            </div>
            <!-- End Single Inner Sidebar -->
          </div>
          ...
          <ul class="nav profile-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="profile-tab-btn active" id="service-tab" data-bs-toggle="tab"
                data-bs-target="#service-tab-pane" type="button" role="tab" aria-controls="service-tab-pane"
                aria-selected="true">
                {{ __('admin.My Service') }}
              </button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="profile-tab-btn" id="portfolio-tab" data-bs-toggle="tab"
                data-bs-target="#portfolio-tab-pane" type="button" role="tab" aria-controls="portfolio-tab-pane"
                aria-selected="false">
                    ...
                    <div class="rounded-xl overflow-hidden relative">
                      ...
                      <div class="absolute left-[10px] bottom-[10px] flex items-center gap-1 z-[3]">
                        ...
                        <div class="flex items-center gap-2">
                          ...
                          <span
                            class="text-white text-sm font-agrandir font-normal">{{ number_format($average, 1) }}</span>
                        </div>
                      </div>
                    </div>
